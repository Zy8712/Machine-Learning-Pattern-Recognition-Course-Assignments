...
[binaryMin, binaryIndex] = max(binaryLossVector);
disp(binaryMin);
disp(binaryIndex);
disp('a');
disp(weightVector(binaryIndex,:));
[hingeMin, hingeIndex] = min(hingeLossVector);
disp(hingeMin);
disp(hingeIndex);
disp('b');
disp(weightVector(hingeIndex,:));
[logisticMin, logisticIndex] = min(logisticLossVector);
disp(logisticMin);
disp(logisticIndex);
disp('c');
disp(weightVector(logisticIndex,:));
